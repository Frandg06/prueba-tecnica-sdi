...
return [
    ...
    | predeterminados usados por la clase validadora de Laravel. Algunas de
    | estas reglas tienen múltiples versiones, como las reglas de tamaño.
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado se ha visto en una filtración de datos. Por favor elige otro :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Puedes especificar mensajes personalizados para atributos usando la
    | convención "attribute.rule" para nombrar las líneas. Esto te permite
    | establecer rápidamente un mensaje específico para una regla y atributo.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Personalización de atributos de validación
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para intercambiar marcadores de
    | posición de atributos por algo más amigable al lector, como "Correo
    | electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer
    | nuestros mensajes más expresivos.
    |
    */
